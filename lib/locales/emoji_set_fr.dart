...
List<CategoryEmoji> get emojiSetFrance => [
// ======================================================= Category.SMILEYS
      CategoryEmoji(Category.SMILEYS, [
        ...
        Emoji('🫶', 'amour | cœur | mains qui forment un cœur',
            hasSkinTone: true),
        Emoji('👋',
        ...
        Emoji(
            '🖐️', 'doigts | main | main levée doigts écartés | paume | stop ',
            hasSkinTone: true),
        Emoji('✋',
        ...
        Emoji('👆',
            ...
            hasSkinTone: true),
        Emoji('🖕', 'doigt | doigt d’honneur | main | majeur',
            hasSkinTone: true),
        Emoji('👇',
        ...
        Emoji('🤛', 'fistbump | gauche | main | poing | poing à gauche',
            hasSkinTone: true),
        Emoji('🤜', 'droite | main | poing | poing à droite',
            hasSkinTone: true),
        Emoji('🫲',
        ...
        Emoji('👂', 'corps | écouter | entendre | oreille | ouïe | son',
            hasSkinTone: true),
        Emoji('👃', 'corps | narines | nez | odeur | sentir',
            hasSkinTone: true),
        Emoji(
          '🧠',
        ...
        Emoji('👶', 'bébé | émoticône | enceinte | enfant | nouveau-né | petit',
            hasSkinTone: true),
        Emoji('🧒', 'enfant | genre neutre | jeune | non-genré',
            hasSkinTone: true),
